...
PROMPTS = "tests/data/prompts.json"
FUNCTIONS_INVALID = "tests/data/functions_invalid.json"
FUNCTIONS_BAD_SCHEMA = "tests/data/functions_bad_schema.json"
PROMPTS_EMPTY = "tests/data/prompts_empty.json"


def capture_error(func, *args):
    buf = io.StringIO()
...
class TestErrorCases:
    ...
    def test_functions_invalid_json(self):
        ...
        print(f"expected: Error: Invalid JSON in {FUNCTIONS_INVALID}")
    ...
    def test_functions_bad_schema(self):
        ...
        print(f"expected: Error: Invalid data in {FUNCTIONS_BAD_SCHEMA}")
    ...
    def test_prompts_empty(self):
        ...
        print(f"prompt  : load_prompts('{PROMPTS_EMPTY}')")
        print("expected: []")
    ...
    def test_model_not_found(self):
        ...
        actual = capture_error(load_model, "nonexistent/model-xyz")
        print(f"actual  : {actual}")
